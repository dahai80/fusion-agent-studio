...
class AgentDispatcher(SubDispatcher):
    ...
    # ── agent publish / archive / clone handlers ──
    ...
    # ── agent status / history / published handlers ──
    ...
    async def _handle_research_adaptive(self, params: dict) -> dict:
        ...
        try:
            ...
            steps_taken += 1
            sub_questions = _re.findall(r"## Sub-question \d+:\s*(.+)", decomp_text)
        ...
        for sq in sub_questions:
            ...
            try:
                ...
                url_pattern = _re.findall(r'https?://[^\s)\]<>"]+', search_text)
